...
import QRCodeGenerator, { CeloPaymentQRCode, generateCeloPaymentURI } from '@/components/qr/QRCodeGenerator'
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg p-6 mb-8">
          <h1 className="text-3xl font-bold mb-2">CAV Community Dashboard</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                      <p className="text-sm text-yellow-800">
                        💡 <strong>Pro tip:</strong> Include a clear description so the payer knows what they're paying for!
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center">
                    {paymentAmount ? (
                      ...
                      <div className="w-220 h-220 bg-gray-100 rounded-lg flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <code className="flex-1 text-sm bg-white border rounded px-3 py-2 font-mono">
                      {MOCK_WALLET_ADDRESS}
                    </code>
                    <button
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h4 className="font-medium text-green-900 mb-2">🌐 Universal compatibility:</h4>
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mt-8 bg-gray-100 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">🛠️ Development Info</h4>
            <div className="text-sm text-gray-700 space-y-1">
              <p><strong>CAV Token:</strong> {MOCK_CAV_TOKEN_ADDRESS}</p>
              <p><strong>Wallet:</strong> {MOCK_WALLET_ADDRESS}</p>
              <p><strong>QR Code Library:</strong> qrcode@1.5.4</p>
              <p><strong>URI Standard:</strong> Celo payment protocol (EIP-681 inspired)</p>
            </div>
          </div>
        )}
      </div>
